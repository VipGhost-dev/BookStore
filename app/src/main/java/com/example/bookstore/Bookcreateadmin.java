...
public class Bookcreateadmin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bookcreateadmin);

        btncreate = findViewById(R.id.btncreate);
        btncreate.setOnClickListener(this);

        dbName = findViewById(R.id.dbName);
        dbAuthor = findViewById(R.id.dbAuthor);
